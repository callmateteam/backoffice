              ...
              <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
                ...
                <div className="rounded-xl bg-amber-50/50 p-4">
                  ...
                  {isEditing ? (
                    ...
                    <div className="notice-content text-sm text-gray-600 leading-relaxed min-h-[100px]"
                      dangerouslySetInnerHTML={{ __html: decodeHtml(detailMeeting.agenda || "") || '<span class="text-gray-400">작성된 안건이 없습니다</span>' }}
                    />
                  )}
                </div>
                ...
                <div className="rounded-xl bg-indigo-50/50 p-4">
                  ...
                  {isEditing ? (
                    ...
                    <div className="notice-content text-sm text-gray-600 leading-relaxed min-h-[100px]"
                      dangerouslySetInnerHTML={{ __html: decodeHtml(detailMeeting.minutes || "") || '<span class="text-gray-400">작성된 회의록이 없습니다</span>' }}
                    />
                  )}
                </div>
              </div>
